...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
			...
			.stake(NFTToStakeContract.address, depositoorContract.address, 42);
			console.log("balance of depositor below");
			console.log( await NFTToStakeContract.balanceOf(depositoorContract.address));
			//I don't see how I can do this without passing time?
			await network.provider.send("evm_increaseTime",[432000]);
			await network.provider.send("evm_mine");
			await attackerContract
			.connect(attackerWallet)
			.attack(depositoorContract.address, 42);
			console.log("hi");
      });
